...
const useMockStudentSessionRequest = (topicId) => {
  const mockSessionResponse = {
    data: {
      ...
      sessionParticipant: {
        ...
        Session: {
          examSet: topicId,
          sessionName: 'English Placement Test - Mock Session'
        }
      },
      status: 'approved'
    }
...
const WaitingForApproval = () => {
  ...
  const { userId, sessionId, requestId, topicId } = useParams()

  const { data, isLoading, isError, error } = useMockStudentSessionRequest(topicId)
