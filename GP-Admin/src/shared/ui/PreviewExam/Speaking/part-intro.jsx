...
const PartIntro = ({ data, partNumber }) => {
    ...
    switch (content) {
      case "PART 1":
        return {
          ...
          description:
            "You will be asked to answer questions about yourself and your experiences.",
      ...
      case "PART 2":
        return {
          ...
          description:
            "You will be shown a picture and asked to describe it in detail.",
          readingTime: "05 seconds",
      ...
      case "PART 3":
        return {
          ...
          description:
            "You will be shown a picture and asked to answer related questions.",
          readingTime: "05 seconds",
          answeringTime: "45 seconds",
          totalQuestions: 3,
          instructions: [
      ...
      case "PART 4":
        return {
          ...
          description:
            "You will be asked to discuss a topic in detail with multiple questions.",
  ...
  const rawPart = data?.[partNumber]?.Content?.toLowerCase()
    .match(/part \d+/)?.[0]
    .toUpperCase();
  ...
  const items = [
    {
      key: "1",
      label: <div className="px-2">Introduction</div>,
      children: (
        <>
            ...
            {rawPart === "PART 4" ? (
              <>
                <div className="text-center">
                  ...
                  <div className="mt-2 text-2xl font-bold text-[#003087]">
                    {info.readingTime}
                  </div>
                </div>
                <div className="text-center">
          ...
          <div className="mb-8">
            <h2 className="mb-4 text-xl font-semibold text-[#003087]">
              Instructions
            </h2>
    ...
    {
      key: "2",
      label: <div className="px-2">Content</div>,
      children: <QuestionDisplay data={data?.[partNumber]} />,
    },
  ];
  return (
    <div className="flex w-full items-center justify-center bg-gray-50">
      <div className="w-full max-w-6xl rounded-2xl border border-gray-200 bg-white p-8 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
