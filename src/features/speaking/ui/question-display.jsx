...
const QuestionDisplay = ({
  ...
  return (
    <div className="relative flex h-screen w-full flex-col bg-white p-4 lg:w-2/3 lg:p-12">
      ...
      {showNavigation && (
        <div className="mt-4 flex items-center justify-end gap-4 lg:mt-6">
          {isAutoAdvancing ? (
            <span className="flex items-center text-sm text-gray-500 lg:text-base">
              <svg
                className="mr-2 h-4 w-4 animate-spin text-[#003087] lg:h-5 lg:w-5"
              ...
              {isUploading ? 'Uploading audio...' : 'Advancing...'}
            </span>
          ) : (
            <button
              ref={buttonRef}
